...
public class t_projectController {
	...
	@Autowired
	t_projectRepository t_project_repository;
	...
	public List<t_project> getAllProject() {
		return t_project_repository.findAll();
	}
...
//		}
	...
	public String closeProject(@ApiParam(required = true, value = "專案表單") @RequestBody t_project t_project) {
		...
		String succse = null;
//		if ("PM".equals(t_project.user)) {
//			t_project _old_t_project = t_project_repository.getOne(t_project.sn);
//			_old_t_project.is_close = false;
//			t_project_repository.save(_old_t_project);
//			succse = "關閉專案成功";
//		} else {
